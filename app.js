...
var ele = document.getElementById('gameView');
ele.width = width - 20;
ele.height = width - 20;
...
var circleArr = [[], [], [], [], [], [], [], [], []];
var currentCat;
var MOVE_NONE = -1, MOVE_LEFT = 0, MOVE_UPLEFT = 1, MOVE_UPRIGHT = 2, MOVE_RIGHT = 3, MOVE_DOWNRIGHT = 4,
    MOVE_DOWNLEFT = 5;
...
function addCircles (radius) {
    for (var indexY = 0; indexY < 9; indexY++) {
        for (var indexX = 0; indexX < 9; indexX++) {
            var c = new Circle();
            gameView.addChild(c);
            circleArr[indexX][indexY] = c;
            c.x = indexY % 2 ? indexX * radius + (radius / 2) : indexX * radius;
            c.y = indexY * radius;
            c.indexX = indexX;
            c.indexY = indexY;
